...
var $author$project$ProductCard$viewProductImage = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('product-image-container')
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$ProductCard$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$ProductCard$viewProductImage(model),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('product-info')
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$ProductGrid$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('product-grid-container')
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$view = function (model) {
	return A2(
		$elm$html$Html$map,
		$author$project$Main$ProductGridMsg,
